...
function chiTietKhoaHoc(obj) {
    ...
    arrTemp = [];
    if (stringID[1] <= 618) {
        document.getElementById('detailCourse').innerHTML = '<div class="bg"><h3><a href="' + dataJson.coursera.learn[stringID[0]].link + '">' + dataJson.coursera.learn[stringID[0]].name + '</a></h3></div>' + '<div class="about-course"><span>' + dataJson.coursera.learn[stringID[0]].about + '</span></div>  <div class="contentCard__dynamicContent"><button id="'+stringID[0]+'__learn" onclick="makeJobForThisCourse(this)"  class="btn-dez" data-toggle="modal"><i class="fa fa-list-alt"></i>Cần biết thêm?</button></div>   <h2>Có thể bạn quan tâm</h2>';

    }
    if (stringID[1] > 618 && stringID[1] <= 973) {
        document.getElementById('detailCourse').innerHTML = '<div class="bg"><h3><a href="' + dataJson.coursera.specializations[stringID[0]].link + '">' + dataJson.coursera.specializations[stringID[0]].name + '</a></h3></div>' + '<div class="about-course"><span>' + dataJson.coursera.specializations[stringID[0]].about_specialization + '</span></div>  <div class="contentCard__dynamicContent"><button id="'+stringID[0]+'__specializations" onclick="makeJobForThisCourse(this)" class="btn-dez" data-toggle="modal"><i class="fa fa-list-alt"></i>Cần biết thêm?</button></div>   <h2>Có thể bạn quan tâm</h2>';

    }
    if (stringID[1] > 973 && stringID[1] <= 995) {
        document.getElementById('detailCourse').innerHTML = '<div class="bg"><h3><a href="' + dataJson.coursera.professional_certificates[stringID[0]].link + '">' + dataJson.coursera.professional_certificates[stringID[0]].name + '</a></h3></div>' + '<div class="about-course"><span>' + dataJson.coursera.professional_certificates[stringID[0]].about_professional_certificate + '</span></div>  <div class="contentCard__dynamicContent"><button id="'+stringID[0]+'__professional_certificates" onclick="makeJobForThisCourse(this)" class="btn-dez" data-toggle="modal"><i class="fa fa-list-alt"></i>Cần biết thêm?</button></div>   <h2>Có thể bạn quan tâm</h2>';
